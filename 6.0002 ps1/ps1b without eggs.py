...
def dp_make_weight(egg_weights, target_weight, eggs_list =[], memo = {}):
    ...
    if target_weight in memo:
        ...
        with_egg = dp_make_weight(egg_weights[:-1], (target_weight - next_egg), eggs_list, memo)
        ...
        print("without_egg is:")
        print(without_egg)
        #Choose better branch
        #find way to figure out 
        if sum(with_egg) <= target_weight:
            eggs_list = with_egg
